...
class UtilisateurController extends AbstractController
{
    ...
    public function login(Request $request, AuthenticationUtils $authenticationUtils, SessionInterface $session): Response
    {
        ...
        // Récupérer l'entité Utilisateur à partir de l'email et du mot de passe
        ...
        if ($user) {
            ...
            return $this->redirectToRoute('front_publication'); // Redirection vers la page front_publication
        } else {
